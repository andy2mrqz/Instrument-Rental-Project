...
namespace BlowOut.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "instrumentID,instDescription,type,price,clientID")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "instrumentID,instDescription,type,price,clientID")] Instrument instrument)
        {
            if (ModelState.IsValid)
            {
